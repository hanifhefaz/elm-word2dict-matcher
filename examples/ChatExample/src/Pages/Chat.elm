...
update msg model =
    case msg of
        ...
        PostedMessage str ->
            let
                answer =
                    Searched <| Word2DictMatcher.findRelevantDict (str |> Word2DictMatcher.tokenize |> Word2DictMatcher.toHistogram) QuestionsBank.data
            ...
            { model
                | messages =
                    { participant = Bot, message = answerMessage }
